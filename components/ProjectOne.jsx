      ...
      >
        <div className="grid grid-cols-2 gap-0">
          ...
          >
            ...
            <p className="ml-5">
              Description: Full Stack E-commerce website that allows user to
              add, edit, delete products. Basically CRUD functions.{" "}
            </p>
            <a
              href="http://jrsushishop.herokuapp.com/"
              target="_blank"
              rel="noreferrer"
              className="ml-5 mt-10 pb-10"
            >
