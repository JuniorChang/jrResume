...
import { faAt, faEnvelope, faSquarePhone } from "@fortawesome/free-solid-svg-icons";
...
const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_j2yfi0o', 'template_wbcxwdc', e.target, 'D0YOMFtf6BKpAzngT')
        .then((result) => {
                ...
                <div className='flex mt-10'>
                    ...
                    <div>
                        ...
                        <Form onSubmit={sendEmail}>
                            ...
                            <Form.Group className="mb-3" >
                                <Form.Control as="textarea" rows={5} placeholder="Your Message to me." name="message" />
                            </Form.Group>
                            <Button variant="primary" type="submit" className='bg-[#00e600] border-double border-4 border-indigo-600 rounded mt-5'>
                                <b>Send Message</b>
                            </Button>
                        </Form>
                    </div>
